...
public class ManageApplicationController {
    ...
    @PostMapping("/addInfo")
    @AopLogger(describe = "添加应用",operateType =LogEnum.INSERT,logType= LogEnum.OPERATETYPE)
    ...
    @AopLogger(describe = "删除应用",operateType =LogEnum.DELECT,logType= LogEnum.OPERATETYPE)
    ...
    @AopLogger(describe = "修改应用",operateType =LogEnum.UPDATE,logType= LogEnum.OPERATETYPE)
    ...
    @AopLogger(describe = "修改应用的key",operateType =LogEnum.UPDATE,logType=LogEnum.OPERATETYPE)
